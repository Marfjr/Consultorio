...
namespace Consultorio.Controllers
{
    ...
    public class PacienteController : ControllerBase
    {
        ...
        {
            var pacientes = await _repository.GetAllPacientesAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            var pacienteExclui = await _repository.GetPacienteByIdAsync(id);
...
//https://www.youtube.com/watch?v=EB8Pl9Axssk&list=PLxd1RHU8YgYkHCbZqtqWuaYHASNERx-Tn&index=16
